...
public class SystemInputExtension
    implements ParameterResolver, BeforeEachCallback, AfterEachCallback {

  @Override
  public void beforeEach(ExtensionContext context) throws IOException {
    ExtensionContext.Store s =
        context.getStore(ExtensionContext.Namespace.create(getClass(), context));
  ...
  public Object resolveParameter(
      ...
      throws ParameterResolutionException {
    ExtensionContext.Store s =
        extensionContext.getStore(ExtensionContext.Namespace.create(getClass(), extensionContext));
  ...
  private void checkAnnotation(ExtensionContext context, WriteOnStdIn wosi) throws IOException {
    String annotationValue =
        context.getRequiredTestMethod().getAnnotation(SystemInLog.class).value();
    if (!annotationValue.isEmpty()) wosi.writeInput(annotationValue);
  }
