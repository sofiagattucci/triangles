...
public class TestEmployee {
    ...
    public void setUp(){
        ...
        employee3 = setUpEmployee("Peach", "Toadstool", LocalDate.of(1996, 12, 29), "peach.toadstool@mail.it");
        employee4 = setUpEmployee("Daisy", "Toadstool", LocalDate.of(1996, 12, 29), "daisy.toadstool@mail.it");
    }
    ...
    public void simpleEmployeeTest(){
        assertThat(employee1).
                ...
                contains(tuple("Mario", "Bros", LocalDate.of(1996, 12, 29), "mario.bros@mail.it").toArray());
    }
